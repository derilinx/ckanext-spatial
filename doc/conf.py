...
latex_documents = [
  ('index', 'ckanext-spatial.tex', 'ckanext-spatial Documentation',
...
man_pages = [
    ('index', 'ckanext-spatial', 'ckanext-spatial Documentation',
...
texinfo_documents = [
  ('index', 'ckanext-spatial', 'ckanext-spatial Documentation',
   'Open Knowledge Foundation', 'ckanext-spatial', 'One line description of project.',
   'Miscellaneous'),
]
